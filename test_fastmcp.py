...
async def run_all_tests():
    print("Testing FastMCP 2.14.3 SOTA updates for Blender MCP...")
    ...
    if success:
        ...
        print("- Agentic Blender workflow orchestration")
        print("- Intelligent 3D processing")
        print("- Conversational Blender assistant")
    else:
