...
class CreateFabricMaterialParams(BaseModel):
    ...
    base_color: List[float] = Field(default=[0.8, 0.75, 0.7], description="Base color as RGB (0-1)", min_items=3, max_items=3)
...
class CreateMetalMaterialParams(BaseModel):
    ...
    base_color: List[float] = Field(default=[1.0, 0.8, 0.0], description="Base color as RGB (0-1)", min_items=3, max_items=3)
...
class CreateWoodMaterialParams(BaseModel):
    ...
    base_color: List[float] = Field(default=[0.6, 0.4, 0.2], description="Base color as RGB (0-1)", min_items=3, max_items=3)
...
class CreateGlassMaterialParams(BaseModel):
    ...
    base_color: List[float] = Field(default=[0.9, 0.95, 1.0], description="Base color as RGB (0-1)", min_items=3, max_items=3)
