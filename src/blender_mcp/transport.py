"""
FastMCP 3.1.1 Dual Transport Configuration
...
Environment Variables:
    ...
    MCP_PORT: Port for HTTP/SSE. Default: 10849 (fleet 10700+; set MCP_PORT to override)
...
ENV_PORT = "MCP_PORT"  # default: 10849
...
def get_transport_config() -> dict:
    ...
    return {
        ...
        "port": int(os.getenv(ENV_PORT, "10849")),
...
""",
    ...
    transport_group.add_argument("--http", action="store_true", help="Run in HTTP Streamable mode (FastMCP 3.1.1+)")
    ...
    parser.add_argument("--port", type=int, default=None, help=f"Port to listen on (default: ${ENV_PORT} or 10849)")
