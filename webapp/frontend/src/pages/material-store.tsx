          ...
          {view === "grid" ? (
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredMaterials.map((material) => (
                <div
                  key={material.id}
                  className="group border border-border rounded-lg bg-card overflow-hidden hover:ring-2 hover:ring-primary transition-all cursor-pointer"
                >
                  <div className="aspect-square bg-muted relative flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                      <button
                        type="button"
                        className="bg-primary text-primary-foreground px-4 py-2 rounded-md text-sm font-medium flex items-center gap-2 transform translate-y-4 group-hover:translate-y-0 transition-all"
                      >
            ...
            <div className="space-y-2">
              {filteredMaterials.map((material) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="opacity-0 group-hover:opacity-100 bg-primary text-primary-foreground px-3 py-1.5 rounded text-sm font-medium transition-opacity"
                  >
                    Apply
                  </button>
                </div>
