...
import { MessageSquare, Send, Bot, User, Sparkles, Paperclip } from 'lucide-react'
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            role: 'assistant',
            content: 'Hello! I\'m your Blender MCP assistant. I can help you create objects, modify scenes, apply materials, and more. What would you like to do?',
            timestamp: new Date()
        }
    ])
