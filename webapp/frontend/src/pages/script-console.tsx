...
import { Play, Save, Trash2, FileCode } from 'lucide-react'
        ...
        <div className="p-6 max-w-6xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
            <div className="mb-6 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    <button className="flex items-center space-x-2 px-4 py-2 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80 transition-colors">
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-0">
                ...
                <div className="flex flex-col border border-border rounded-lg bg-card overflow-hidden shadow-sm">
                    ...
                    <div className="flex-1 p-4 bg-[#0d1117] font-mono text-sm overflow-y-auto">
                        ...
                        {output.map((line, i) => (
                            <div key={i} className="text-gray-300 border-b border-white/5 pb-1 mb-1 last:border-0 last:pb-0 last:mb-0">
                                {line}
                            </div>
                        ))}
                    </div>
