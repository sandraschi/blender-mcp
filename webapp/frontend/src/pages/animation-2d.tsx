  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Animate Grease Pencil strokes — keyframes, interpolation, modifiers
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <OpButton
          ...
          params={{
            ...
            interpolation_frames: interpFrames,
          }}
        />
        <OpButton
          label="Add Modifier"
          icon={StopCircle}
          params={{ operation: "add_modifier", gp_object: gpName, modifier_type: modifierType }}
        />
        <OpButton
          label="Frame -1"
          icon={SkipBack}
          params={{
            ...
            gp_object: gpName,
            layer_name: layerName,
            frame_number: Math.max(1, frameNum - 1),
          }}
        />
        <OpButton
          label="Frame +1"
      ...
      <div className="border border-border rounded-lg p-4 space-y-4 bg-card">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="space-y-2">
            <label htmlFor="anim-gp-object" className="text-xs font-medium text-muted-foreground">
              GP Object
            </label>
            <input
              id="anim-gp-object"
          ...
          <div className="space-y-2">
            <label htmlFor="anim-layer" className="text-xs font-medium text-muted-foreground">
              Layer
            </label>
            <input
              id="anim-layer"
          ...
          <div className="space-y-2">
            <label htmlFor="anim-frame" className="text-xs font-medium text-muted-foreground">
              Frame
            </label>
            <input
              id="anim-frame"
      ...
      <div className="border border-border rounded-lg p-4 space-y-4 bg-card">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="space-y-2">
            <label htmlFor="anim-start-frame" className="text-xs font-medium text-muted-foreground">
              Start Frame
            </label>
            <input
              id="anim-start-frame"
          ...
          <div className="space-y-2">
            <label htmlFor="anim-end-frame" className="text-xs font-medium text-muted-foreground">
              End Frame
            </label>
            <input
              id="anim-end-frame"
          ...
          <div className="space-y-2">
            ...
            <input
              id="anim-interp-frames"
              type="number"
              value={interpFrames}
              onChange={(e) => setInterpFrames(Number(e.target.value))}
              min={1}
              max={50}
              className="w-full px-3 py-2 bg-secondary rounded-lg text-sm border border-border"
            />
          ...
          <div className="space-y-2">
            <label htmlFor="anim-modifier" className="text-xs font-medium text-muted-foreground">
              Modifier
            </label>
            <select
              id="anim-modifier"
      ...
      <div className="border border-border rounded-lg p-4 space-y-3 bg-card">
        ...
        <div className="flex flex-wrap gap-2">
          <OpButton
            label="Set Layer"
            icon={Layers}
            params={{ operation: "set_layer", gp_object: gpName, layer_name: layerName }}
          />
          <OpButton
            label="Fill Region"
            icon={StopCircle}
