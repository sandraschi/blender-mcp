...
class TestListAndSearch:
    ...
    async def test_search_by_query(self, repo_dir: Path):
        ...
        result = await _search_objects(
            query="chair", category=None, tags=None, author=None, min_quality=None, complexity=None, limit=10
        )
    ...
    async def test_search_by_min_quality(self, repo_dir: Path):
        ...
        result = await _search_objects(
            query=None, category=None, tags=None, author=None, min_quality=7, complexity=None, limit=10
        )
        assert result["total_matches"] == 1
    ...
    async def test_search_by_tags(self, repo_dir: Path):
        ...
        result = await _search_objects(
            query=None, category=None, tags=["robot"], author=None, min_quality=None, complexity=None, limit=10
        )
        assert result["total_matches"] == 1
